...
const file_connectrpc_eliza_v1_eliza_proto_rawDesc = "" +
	...
	"\bsentence\x18\x01 \x01(\tR\bsentence2Z\n" +
	"\fElizaService\x12J\n" +
	"\x03Say\x12\x1f.connectrpc.eliza.v1.SayRequest\x1a .connectrpc.eliza.v1.SayResponse\"\x00B+Z)server-go/gen/connectrpc/eliza/v1;elizav1b\x06proto3"
...
var file_connectrpc_eliza_v1_eliza_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
var file_connectrpc_eliza_v1_eliza_proto_depIdxs = []int32{
	...
	1, // 1: connectrpc.eliza.v1.ElizaService.Say:output_type -> connectrpc.eliza.v1.SayResponse
